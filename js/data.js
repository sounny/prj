...
const PROJECTIONS = [
  {
    ...
    epsg: null,
    epsgNote: "Not registered in the EPSG Geodetic Parameter Dataset. Spherical, non-standard projection.",
  ...
  CS[Cartesian, 2],
    ...
    AXIS["(N)", north,
      ...
      esri_wkt: {
        label: "ESRI WKT",
        description: "ESRI Well-Known Text format, compatible with ArcGIS and ESRI products.",
        content: `PROJCS["Nicolosi_Globular",GEOGCS["GCS_Sphere",DATUM["D_Sphere",SPHEROID["Sphere",6371000.0,0.0]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Nicolosi_Globular"],PARAMETER["Central_Meridian",0.0],PARAMETER["False_Easting",0.0],PARAMETER["False_Northing",0.0],UNIT["Meter",1.0]]`,
        humanReadable: [
          ["Format", "ESRI WKT (ArcGIS / ArcPro compatible)"],
          ["Projection Name", "Nicolosi_Globular"],
          ["Geographic CRS", "GCS_Sphere"],
          ["Datum", "D_Sphere"],
          ["Spheroid Name", "Sphere"],
          ["Semi-Major Axis", "6,371,000.0 m"],
          ["Inverse Flattening", "0.0 (perfect sphere)"],
          ...
          ["False Northing", "0.0 m"],
          ["Linear Unit", "Meter (1.0)"],
          ["Note", "ESRI WKT uses PROJECTION[] keyword; method name may not be recognized in older ArcGIS versions without a custom projection definition."],
        ]
      },
      prj: {
        label: ".PRJ",
